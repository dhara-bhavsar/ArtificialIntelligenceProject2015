...
{  
	...
	public WindowPanel(Hand varHand1, Hand varHand2)  
	{  
		this.gameOver = false;  
		...
		this.playersHand[0] = varHand1;  
		this.dealersHand = varHand2;  
		this.betAmount = 1;  
	...
	{  
		...
		this.coord = new Point[9];  
		this.picOnTable = new int[9];  
		...
		{  
			...
			this.cardImage[(j + 7)  ] = Toolkit.getDefaultToolkit()  .getImage("images/C" + (j + 1)   + ".png")  ;  
			this.cardImage[(j + 14)  ] = Toolkit.getDefaultToolkit()  .getImage("images/D" + (j + 1)   + ".png")  ;  
			this.cardImage[(j + 21)  ] = Toolkit.getDefaultToolkit()  .getImage("images/H" + (j + 1)   + ".png")  ;  
			this.tracker.addImage(this.cardImage[j], 0)  ;  
			this.tracker.addImage(this.cardImage[(j + 7)  ], 0)  ;  
			this.tracker.addImage(this.cardImage[(j + 14)  ], 0)  ;  
			this.tracker.addImage(this.cardImage[(j + 21)  ], 0)  ;  
		}  
		for (int k = 0;   k < 5;   k++)  
		{  
		...
		this.cardImage[28] = Toolkit.getDefaultToolkit()  .getImage("images/cardback.jpeg")  ;  
		this.tracker.addImage(this.cardImage[28], 0)  ;  
	...
	public void addPicture(Hand varHand1, Hand varHand2)  
	{  
		this.playersHand[this.currentHand] = varHand1;  
		this.dealersHand = varHand2;  
		repaint()  ;  
	}  

	public void splitHand(Hand varHand1, Hand varHand2)  
	{  
		this.playersHand[this.currentHand] = varHand1;  
		this.playersHand[this.numberOfHands] = varHand2;  
